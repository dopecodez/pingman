export const ERROR_MESSAGES = {
    ...
    GENERAL_PING_ERROR: 'Error while running ping. Check permissions and arguments',
    SPAWN_ERROR: 'There was an error when spawning application with arguments args'
}